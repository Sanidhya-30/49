...
{
  new (message_memory) task_2_interface::msg::JointData(_init);
}

void JointData_fini_function(void * message_memory)
{
  auto typed_message = static_cast<task_2_interface::msg::JointData *>(message_memory);
  typed_message->~JointData();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember JointData_message_member_array[2] = {
  {
    "center",  // name
    ...
    offsetof(task_2_interface::msg::JointData, center),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(task_2_interface::msg::JointData, vel),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers JointData_message_members = {
  "task_2_interface::msg",  // message namespace
  "JointData",  // message name
  2,  // number of fields
  sizeof(task_2_interface::msg::JointData),
...
{
  return &::task_2_interface::msg::rosidl_typesupport_introspection_cpp::JointData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, task_2_interface, msg, JointData)() {
  return &::task_2_interface::msg::rosidl_typesupport_introspection_cpp::JointData_message_type_support_handle;
}
