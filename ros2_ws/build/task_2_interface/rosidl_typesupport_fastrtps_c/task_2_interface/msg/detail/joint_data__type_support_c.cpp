...
#include "task_2_interface/msg/detail/joint_data__rosidl_typesupport_fastrtps_c.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_task_2_interface
...
using _JointData__ros_msg_type = task_2_interface__msg__JointData;
...
size_t get_serialized_size_task_2_interface__msg__JointData(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _JointData__ros_msg_type * ros_message = static_cast<const _JointData__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _JointData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_task_2_interface__msg__JointData(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_task_2_interface
size_t max_serialized_size_task_2_interface__msg__JointData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = task_2_interface__msg__JointData;
    is_plain =
      (
...
static size_t _JointData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_task_2_interface__msg__JointData(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, task_2_interface, msg, JointData)() {
