...
bool task_2_interface__msg__joint_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("task_2_interface.msg._joint_data.JointData", full_classname_dest, 42) == 0);
  }
  task_2_interface__msg__JointData * ros_message = _ros_message;
  {  // center
...
PyObject * task_2_interface__msg__joint_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("task_2_interface.msg._joint_data");
