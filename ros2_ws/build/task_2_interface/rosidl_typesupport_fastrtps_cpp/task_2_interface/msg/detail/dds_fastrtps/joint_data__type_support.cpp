...
#include "task_2_interface/msg/detail/joint_data__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = task_2_interface::msg::JointData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const task_2_interface::msg::JointData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<task_2_interface::msg::JointData *>(
    untyped_ros_message);
...
{
  return &task_2_interface::msg::typesupport_fastrtps_cpp::_JointData__handle;
}
