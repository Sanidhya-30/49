...
task_2_interface__msg__JointData__init(task_2_interface__msg__JointData * msg)
{
  ...
  if (!geometry_msgs__msg__Point32__init(&msg->center)) {
    task_2_interface__msg__JointData__fini(msg);
    return false;
  }
  // vel
  return true;
...
task_2_interface__msg__JointData__create()
{
  ...
  task_2_interface__msg__JointData * msg = (task_2_interface__msg__JointData *)allocator.allocate(sizeof(task_2_interface__msg__JointData), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(task_2_interface__msg__JointData));
  bool success = task_2_interface__msg__JointData__init(msg);
  if (!success) {
...
task_2_interface__msg__JointData__Sequence__init(task_2_interface__msg__JointData__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  task_2_interface__msg__JointData * data = NULL;

  if (size) {
    data = (task_2_interface__msg__JointData *)allocator.zero_allocate(size, sizeof(task_2_interface__msg__JointData), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = task_2_interface__msg__JointData__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        task_2_interface__msg__JointData__fini(&data[i - 1]);
      }
...
task_2_interface__msg__JointData__Sequence__fini(task_2_interface__msg__JointData__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      task_2_interface__msg__JointData__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  task_2_interface__msg__JointData__Sequence * array = (task_2_interface__msg__JointData__Sequence *)allocator.allocate(sizeof(task_2_interface__msg__JointData__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = task_2_interface__msg__JointData__Sequence__init(array, size);
  if (!success) {
...
task_2_interface__msg__JointData__Sequence__destroy(task_2_interface__msg__JointData__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    task_2_interface__msg__JointData__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
task_2_interface__msg__JointData__Sequence__are_equal(const task_2_interface__msg__JointData__Sequence * lhs, const task_2_interface__msg__JointData__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!task_2_interface__msg__JointData__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  task_2_interface__msg__JointData__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(task_2_interface__msg__JointData);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    task_2_interface__msg__JointData * data =
      (task_2_interface__msg__JointData *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!task_2_interface__msg__JointData__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          task_2_interface__msg__JointData__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!task_2_interface__msg__JointData__copy(
